...
def parse_gaussian_esp(f: TextIO) -> GaussianEspData:
    ...
    ----------
    f : TextIO
        The file object representing the .esp file opened for reading. The
        .esp file can be generated by specifying the override ``IOp(6/50=1)``.
...
def parse_resp_esp(f: TextIO) -> EspData:
    ...
    ----------
    f : TextIO
        The file object representing the .esp file opened for reading.
...
def write_resp_esp(f: TextIO, esp_data: EspData):
    ...
    ----------
    f : TextIO
        The file object representing the .esp file opened for writing.
    esp_data : EspData

...
class TestAtom(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.coords = Coords((1, 1, 2))
        self.charge = Charge(0.6)
...
class TestMolecule(TestCase):
    ...
    def test_ctors(self) -> None:
        ...
        Molecule(
            [
                AtomWithCoords(1, Coords((1, 1, 2))),
                AtomWithCoords(2, Coords((2, 0, 2))),
            ]
        )

        Molecule(
            [
                AtomWithCharge(1, Charge(0.6)),
                AtomWithCharge(2, Charge(-0.2)),
            ]
        )
